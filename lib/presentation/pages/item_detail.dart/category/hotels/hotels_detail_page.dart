...
class HotelDetailPage extends StatelessWidget {
  ...
  const HotelDetailPage({super.key, required this.data});
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ingredients(
                          context, 'Cost: \$${data["hotel_price"] ?? "None"}'),
                      ingredients(context, 'Opening Hours:'),

                      ingredients2(context,
                          'Balcony: ${data["hotel_facilities"]["facility_balcony"] == "true" ? "True" : "False" ?? "None"}'),
                      ingredients2(context,
                          'Kitchen: ${data["hotel_facilities"]["facility_kitchen"] == "true" ? "True" : "False" ?? "None"}'),
                      ingredients2(context,
                          'Parking: ${data["hotel_facilities"]["facility_parking"] == "true" ? "True" : "False" ?? "None"}'),
                      ingredients2(context,
                          'Swimming Pool: ${data["hotel_facilities"]["facility_swimming"] == "true" ? "True" : "False" ?? "None"}'),
